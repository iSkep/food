...
function calc() {
    ...
    getStaticInformation('.calculating__choose_big .calculating__choose-item', 'calculating__choose-item_active');
...
function cards() {
    ...
    // Second variant w/o classes (no templating, just one-time build)
...
function slider({container, slide, nextArrow, prevArrow, totalCounter, currentCounter, wrapper, field}) {
    ...
    slideTotal.innerHTML = (0,_timer__WEBPACK_IMPORTED_MODULE_0__.getZero)(slides.length);
    slideCurrent.innerHTML = (0,_timer__WEBPACK_IMPORTED_MODULE_0__.getZero)(slideIndex);
...
const modalTimerId = setTimeout(() => (0,_modules_modal__WEBPACK_IMPORTED_MODULE_1__.openModal)('.modal', modalTimerId), 30000);
    ...
    (0,_modules_timer__WEBPACK_IMPORTED_MODULE_2__["default"])('.timer', '2022-12-01');
